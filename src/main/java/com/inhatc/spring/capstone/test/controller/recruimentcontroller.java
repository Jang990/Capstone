...
public class recruimentcontroller {
	...
	class recruimentDto{
		...
		public recruimentDto(String title,String email,String writer,int viewCount,
				String ends,String usedLanguage,int count) {
		this.title = title;
		this.writer =writer;
		this.email=email;
	...
	public String recruimentboard(Model model) {
		...
		recruimentDto test1 = new recruimentDto("캡스톤 디자인관리", "email@mail.com","김상덕",76,"프론트엔드","자바",3);
		recruimentDto test2 = new recruimentDto("이메일 관리", "1email@mail.com", "길드", 79,"백엔드","c",1);
		recruimentDto test3 = new recruimentDto("드론 프로젝트", "3email@mail.com", "라이트", 77,"백엔드","python",1);
